...
def add_liquidity(currency_a_id: int, currency_b_id: int, amount_a: int, amount_b: int) -> Any: ...
def remove_liquidity(currency_a_id: int, currency_b_id: int, shares: int) -> Any: ...
